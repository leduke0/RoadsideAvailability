...
const String tSignUpSubTitle = "Create your profile to get a technician.";
...
const String tOtpTitle = "C0\nDE";
const String tOtpSubTitle = "Verification";
const String tOtpMessage = "Enter the verification code sent at";

// -- Dashboard Screen - Text
const String tDashboardTitle = "Hey Welcome Back!";
const String tDashboardHeading = "Explore Technicians";
const String tDashboardSearch = "Search for Technicians";	
const String tDashboardBannerTitle1 = "Get your";
const String tDashboardBannerTitle2 = "Technician";
