    ...
    return Container(
      ...
      child: Column
       (
        ...
        Text(data['timestamp'].toDate().toString().substring(10, 16), style: const TextStyle(fontSize: 12, color: Colors.black),),
      ]),
    );
  }
  ...
  Widget _buildMessageInput() {
    return Padding(
      ...
      child: Row(children: [
        ...
        // send button
        IconButton(onPressed: sendMessage, icon: const Icon(Icons.send, size: 30, color: Colors.teal,),),
      ],),
    );
  }
}
